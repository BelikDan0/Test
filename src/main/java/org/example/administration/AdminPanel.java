...
public class AdminPanel {
    ...
    //Шаблон при старте программы
    public void generateTemplateCategories() {
        List<Category> categories = new ArrayList<>();

        // Категория 1
        List<Question> q1 = new ArrayList<>();
        q1.add(new Question("2 + 2 = ?", List.of("3", "4", "5"), 1, 1));
        q1.add(new Question("5 * 3 = ?", List.of("10", "15", "20"), 1, 1));
        q1.add(new Question("9 - 4 = ?", List.of("3", "4", "5"), 2, 1));
        categories.add(new Category("Простая математика", 3, q1));

        // Категория 2
        List<Question> q2 = new ArrayList<>();
        q2.add(new Question("10 / 2 = ?", List.of("2", "5", "10"), 1, 1));
        q2.add(new Question("7 + 6 = ?", List.of("12", "13", "14"), 1, 1));
        q2.add(new Question("8 * 2 = ?", List.of("14", "16", "18"), 1, 1));
        categories.add(new Category("Средняя математика", 3, q2));

        // Категория 3
        List<Question> q3 = new ArrayList<>();
        q3.add(new Question("3 * 3 = ?", List.of("6", "9", "12"), 1, 1));
        q3.add(new Question("12 - 5 = ?", List.of("6", "7", "8"), 1, 1));
        q3.add(new Question("4 + 7 = ?", List.of("10", "11", "12"), 1, 1));
        categories.add(new Category("Еще математика", 3, q3));
